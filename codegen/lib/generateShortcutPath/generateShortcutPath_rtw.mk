...
PRODUCT_NAME              = generateShortcutPath
MAKEFILE                  = generateShortcutPath_rtw.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/under/MATLAB~1/PATHPL~2/codegen/lib/GENERA~1
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = generateShortcutPath_rtw_comp.rsp
CMD_FILE                  = generateShortcutPath_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = generateShortcutPath.lib
...
PRODUCT = ./generateShortcutPath.lib
...
DEFINES_STANDARD = -DMODEL=generateShortcutPath
...
generateShortcutPath_data.o : $(START_DIR)/generateShortcutPath_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
generateShortcutPath_initialize.o : $(START_DIR)/generateShortcutPath_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


generateShortcutPath_terminate.o : $(START_DIR)/generateShortcutPath_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


generateShortcutPath.o : $(START_DIR)/generateShortcutPath.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
generateShortcutPath_emxutil.o : $(START_DIR)/generateShortcutPath_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"
