...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "generateShortcutPath",                               /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *src_course,
                             ...
                             const char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(src_course), &thisId, y);
  emlrtDestroyArray(&src_course);
}

/*
 * Arguments    : const real_T u[19998]
...
void generateShortcutPath_atexit(void)
{
  ...
  generateShortcutPath_xil_terminate();
  generateShortcutPath_xil_shutdown();
...
/*
 * File trailer for _coder_generateShortcutPath_api.c
 *
 * [EOF]
 */
